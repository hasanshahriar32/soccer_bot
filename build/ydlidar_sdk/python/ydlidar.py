...
class CYdLidar(object):
    ...
    def isScanning(self):
        return _ydlidar.CYdLidar_isScanning(self)
    ...
    def setWorkMode(self, mode, addr=0):
        return _ydlidar.CYdLidar_setWorkMode(self, mode, addr)

    def enableSunNoise(self, e=True):
        return _ydlidar.CYdLidar_enableSunNoise(self, e)

    def enableGlassNoise(self, e=True):
        return _ydlidar.CYdLidar_enableGlassNoise(self, e)

    def getUserVersion(self, version):
        return _ydlidar.CYdLidar_getUserVersion(self, version)

    def setBottomPriority(self, yes=True):
        return _ydlidar.CYdLidar_setBottomPriority(self, yes)

    def getDeviceInfo(self, *args):
        return _ydlidar.CYdLidar_getDeviceInfo(self, *args)

    def setAutoIntensity(self, yes=False):
        return _ydlidar.CYdLidar_setAutoIntensity(self, yes)

    def getPitchAngle(self, pitch):
        return _ydlidar.CYdLidar_getPitchAngle(self, pitch)

    def setEnableDebug(self, yes):
        return _ydlidar.CYdLidar_setEnableDebug(self, yes)

    def setOtaFile(self, name):
        return _ydlidar.CYdLidar_setOtaFile(self, name)

    def setOtaEncode(self, e):
        return _ydlidar.CYdLidar_setOtaEncode(self, e)

    def ota(self, addr=0):
        return _ydlidar.CYdLidar_ota(self, addr)
...
def printLogo():
    return _ydlidar.printLogo()
MAX_DEBUG_INDEX = _ydlidar.MAX_DEBUG_INDEX
class LaserDebug(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    cVer = property(_ydlidar.LaserDebug_cVer_get, _ydlidar.LaserDebug_cVer_set)
    debug2 = property(_ydlidar.LaserDebug_debug2_get, _ydlidar.LaserDebug_debug2_set)
    hfVer = property(_ydlidar.LaserDebug_hfVer_get, _ydlidar.LaserDebug_hfVer_set)
    fVer = property(_ydlidar.LaserDebug_fVer_get, _ydlidar.LaserDebug_fVer_set)
    month = property(_ydlidar.LaserDebug_month_get, _ydlidar.LaserDebug_month_set)
    day = property(_ydlidar.LaserDebug_day_get, _ydlidar.LaserDebug_day_set)
    year = property(_ydlidar.LaserDebug_year_get, _ydlidar.LaserDebug_year_set)
    numH = property(_ydlidar.LaserDebug_numH_get, _ydlidar.LaserDebug_numH_set)
    numL = property(_ydlidar.LaserDebug_numL_get, _ydlidar.LaserDebug_numL_set)
    health = property(_ydlidar.LaserDebug_health_get, _ydlidar.LaserDebug_health_set)
    model = property(_ydlidar.LaserDebug_model_get, _ydlidar.LaserDebug_model_set)
    maxIndex = property(_ydlidar.LaserDebug_maxIndex_get, _ydlidar.LaserDebug_maxIndex_set)
...
class LaserScan(object):
    ...
    scanFreq = property(_ydlidar.LaserScan_scanFreq_get, _ydlidar.LaserScan_scanFreq_set)
    sampleRate = property(_ydlidar.LaserScan_sampleRate_get, _ydlidar.LaserScan_sampleRate_set)
    points = property(_ydlidar.LaserScan_points_get, _ydlidar.LaserScan_points_set)
    size = property(_ydlidar.LaserScan_size_get, _ydlidar.LaserScan_size_set)
    config = property(_ydlidar.LaserScan_config_get, _ydlidar.LaserScan_config_set)
    moduleNum = property(_ydlidar.LaserScan_moduleNum_get, _ydlidar.LaserScan_moduleNum_set)
    envFlag = property(_ydlidar.LaserScan_envFlag_get, _ydlidar.LaserScan_envFlag_set)
...
YDLIDAR_TYPE_UDP = _ydlidar.YDLIDAR_TYPE_UDP
TYPE_TOF = _ydlidar.TYPE_TOF
TYPE_TRIANGLE = _ydlidar.TYPE_TRIANGLE
TYPE_TOF_NET = _ydlidar.TYPE_TOF_NET
TYPE_GS = _ydlidar.TYPE_GS
TYPE_SCL = _ydlidar.TYPE_SCL
TYPE_SDM = _ydlidar.TYPE_SDM
TYPE_SDM18 = _ydlidar.TYPE_SDM18
TYPE_TIA = _ydlidar.TYPE_TIA
...
LidarPropIntenstiyBit = _ydlidar.LidarPropIntenstiyBit
